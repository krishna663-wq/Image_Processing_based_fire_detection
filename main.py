...
import os#Operating system module to play sound
v=cv2.VideoCapture(0)#Capture live video using camera 0 (default webcam) and store values in v
time.sleep(2)#pause for 2 seconds
fdc=cv2.CascadeClassifier('fire_detection.xml')#Load generated cascade classifier into fdc
...
while(1):#Loop code continously
        ...
        #     winsound.Beep(frequency, duration)
              os.system("afplay alert.wav")#Sound alarm
